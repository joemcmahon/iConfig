...
mac: QMAKE_CXXFLAGS = -std=c++17 -Wno-unused-parameter -Wno-deprecated-register -O2
mac: QMAKE_LFLAGS = -std=c++17 -Wno-unused-parameter -Wno-deprecated-register -O2

mac: LIBS           += -framework CoreMIDI
mac: LIBS           += -framework CoreFoundation
mac: LIBS           += -framework CoreAudio

mac: DEPENDPATH     += /opt/homebrew/include/rtmidi
mac: INCLUDEPATH    += /opt/homebrew/include/rtmidi
...
else:macx: PRE_TARGETDEPS += $$PWD/../GeneSysLib/Qt/libGeneSysLib.a
